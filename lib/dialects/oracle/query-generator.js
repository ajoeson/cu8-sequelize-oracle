...
var Utils = require('../../utils'),
  ...
  SqlString = require('./sql-string.js'),
  Model = require('../../model'),
  util = require('util'),
  _ = require('lodash');
      ...
      if (options.order) {
        ...
        if (Array.isArray(options.order)) {
          options.order.forEach(function(t) {
            ...
            try{t[0].val=substituteSAs(t[0].val);}catch(ex){/*console.log("[ERROR] Exception in substituteSAs.", ex)*/}//correct aliases in order statements
