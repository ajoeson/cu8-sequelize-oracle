...
var LIB_OracleDB = null;
const FS = require("fs");
if (FS.existsSync(`${process.cwd()}/node-oracledb`)) {
    LIB_OracleDB = require(`${process.cwd()}/node-oracledb/node_modules/oracledb`);
} else {
    LIB_OracleDB = require("oracledb");
}
...
var Sequelize = function(database, username, password, options) {
    ...
    try {
        var oracleDialect = require("./dialects/oracle");
        var Dialect = this.getDialect() == "oracle" ? oracleDialect : require('./dialects/' + this.getDialect());
        this.dialect = new Dialect(this, LIB_OracleDB);
    } catch (err) {
